...
// app/admin/campanas/landings/comparar. Contador diario por landing y tipo
// de evento, no un log por evento: ver lib/store.ts trackLandingEvent.
export async function POST(request: Request) {
  ...
  await trackLandingEvent(slug, kind as LandingEventKind);
