...
// vía segura, ya que el id no lo controla el cliente. Si no hay sesión
// (por ejemplo, un guardado justo antes de que la cookie recién creada haga
// efecto), recurre a localizar por teléfono/email como antes.
