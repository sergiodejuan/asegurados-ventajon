...
export const metadata: Metadata = {
  title: `Calcula tu precio · Seguro de decesos — ${BRAND_NAME}`,
  description: "Compara tu seguro de decesos entre las mejores compañías y calcula tu precio en un minuto, sin compromiso.",
};

export default function TarificadorDecesos() {
  return (
      ...
      <div className="mx-auto max-w-app px-5 py-6 md:max-w-5xl md:py-0 lg:max-w-6xl">
        ...
        <Suspense fallback={<div className="h-[480px] rounded-[24px] border border-hair bg-white shadow-card md:h-[560px]" />}>
          <TarificadorExperience
            variant="decesos"
            heading="Calcula tu precio de seguro de decesos"
