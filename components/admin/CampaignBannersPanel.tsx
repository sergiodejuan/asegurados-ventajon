...
// Editor de los banners de campaña "a mano" (varias diapositivas con imagen,
// precio, textos y CTA propios). Vive dentro de /admin/promociones (pestaña
// "Banners de campaña") junto a las promociones del CMS: ambos alimentan el
// mismo carrusel de la Home, así que tiene sentido gestionarlos desde el
// mismo sitio.
export function CampaignBannersPanel() {
  ...
  return (
    <div className="pb-24">
      <p className="text-[13px] leading-relaxed text-slate2">
        Diapositivas de campaña "a mano": imagen, precio, textos y CTA propios. Se muestran en la home, mezcladas con
        las promociones que marques como "Mostrar en la Home" desde la pestaña Promociones. Puedes añadir varias,
        reordenarlas, ocultar alguna sin borrarla y ajustar el tiempo entre cada una.
      </p>
    ...
    <div className="rounded-[20px] border border-hair bg-white p-5">
      ...
      <div className="mt-4 flex flex-col gap-3">
        ...
        <p className="text-[11px] leading-relaxed text-slate2">
          También puedes enlazar directamente a una promoción de la pestaña Promociones, p.ej. /promociones/mi-promocion.
        </p>
      </div>
    </div>
  );
